...
PYBIND11_MODULE( record3d, m )
{
    ...
    py::class_<Record3D::Record3DStream>( m, "Record3DStream" )
            ...
            .def_static( "get_version", &Record3D::Record3DStream::GetVersion, "Returns the version string of the Record3D library." )
            .def("disconnect", &Record3D::Record3DStream::Disconnect, py::call_guard<py::gil_scoped_release>(), "Close connection to currently paired iOS device.")
            .def("connect", &Record3D::Record3DStream::ConnectToDevice, py::call_guard<py::gil_scoped_release>(), "Connect to iOS device and start receiving RGBD frames.")
